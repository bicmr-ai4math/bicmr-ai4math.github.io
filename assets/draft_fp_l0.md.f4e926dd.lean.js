import{_ as s,v as a,b as n,R as l}from"./chunks/framework.3ac7bdc3.js";const e="/assets/rs.17f17407.png",t="/assets/parsec.88c31b1e.png",p="/assets/free.e658b495.png",m=JSON.parse('{"title":"Lean 函数式程序设计","description":"","frontmatter":{},"headers":[],"relativePath":"draft/fp/l0.md","filePath":"draft/fp/l0.md"}'),o={name:"draft/fp/l0.md"},i=l(`<h1 id="lean-函数式程序设计" tabindex="-1">Lean 函数式程序设计 <a class="header-anchor" href="#lean-函数式程序设计" aria-label="Permalink to &quot;Lean 函数式程序设计&quot;">​</a></h1><h2 id="动机" tabindex="-1">动机 <a class="header-anchor" href="#动机" aria-label="Permalink to &quot;动机&quot;">​</a></h2><ul><li>许多策略会被翻译成函数式程序设计的常见组分，学习函数式程序设计对读懂这些策略具体如何工作有帮助</li></ul><div class="language-Lean4"><button title="Copy Code" class="copy"></button><span class="lang">Lean4</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">def id {A : Type _} (x : A) : A := x</span></span>
...
<span class="line"><span style="color:#A6ACCD;">join xss = xss &gt;&gt;= id</span></span></code></pre></div><h2 id="io" tabindex="-1"><a href="https://leanprover-community.github.io/mathlib4_docs/Init/System/IO.html" target="_blank" rel="noreferrer">IO</a> <a class="header-anchor" href="#io" aria-label="Permalink to &quot;[IO](https://leanprover-community.github.io/mathlib4_docs/Init/System/IO.html)&quot;">​</a></h2><ul><li>main</li></ul><h2 id="monad-transformers" tabindex="-1">Monad Transformers <a class="header-anchor" href="#monad-transformers" aria-label="Permalink to &quot;Monad Transformers&quot;">​</a></h2><ul><li>State</li></ul><div class="language-Lean4"><button title="Copy Code" class="copy"></button><span class="lang">Lean4</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">inductive State (S : Type _) : Type _ -&gt; Type _ where</span></span>
<span class="line"><span style="color:#A6ACCD;">  | get : State S S</span></span>
<span class="line"><span style="color:#A6ACCD;">  | put : S -&gt; State S Unit</span></span>
<span class="line"><span style="color:#A6ACCD;">  | pure : {A : Type _} -&gt; A -&gt; State S A</span></span>
<span class="line"><span style="color:#A6ACCD;">  | bind : {A : Type _} -&gt; {B : Type _}</span></span>
<span class="line"><span style="color:#A6ACCD;">        -&gt; State S A</span></span>
<span class="line"><span style="color:#A6ACCD;">        -&gt; (A -&gt; State S B)</span></span>
<span class="line"><span style="color:#A6ACCD;">        -&gt; State S B</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">instance {S : Type _} : Monad (State S) where</span></span>
<span class="line"><span style="color:#A6ACCD;">  pure := State.pure</span></span>
<span class="line"><span style="color:#A6ACCD;">  bind := State.bind</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">def runState {S A : Type _} : S -&gt; State S A -&gt; A × S :=</span></span>
<span class="line"><span style="color:#A6ACCD;">  fun init xs =&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">    match xs with</span></span>
<span class="line"><span style="color:#A6ACCD;">    | .get =&gt; (init, init)</span></span>
<span class="line"><span style="color:#A6ACCD;">    | .put st =&gt; ((), st)</span></span>
<span class="line"><span style="color:#A6ACCD;">    | .pure x =&gt; (x, init)</span></span>
<span class="line"><span style="color:#A6ACCD;">    | .bind xs k =&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">        let ⟨x, st⟩ := runState init xs</span></span>
<span class="line"><span style="color:#A6ACCD;">        runState st (k x)</span></span></code></pre></div><ul><li>Identity</li><li>StateT</li></ul><h2 id="intuitionistic-logic" tabindex="-1">Intuitionistic Logic <a class="header-anchor" href="#intuitionistic-logic" aria-label="Permalink to &quot;Intuitionistic Logic&quot;">​</a></h2><h2 id="further-reading" tabindex="-1">Further Reading <a class="header-anchor" href="#further-reading" aria-label="Permalink to &quot;Further Reading&quot;">​</a></h2><ul><li>more about monads <ul><li><a href="https://homepages.inf.ed.ac.uk/wadler/papers/monads/monads.dvi" target="_blank" rel="noreferrer">Comprehending monads</a></li><li><a href="https://www.cambridge.org/core/journals/journal-of-functional-programming/article/data-types-a-la-carte/14416CB20C4637164EA9F77097909409" target="_blank" rel="noreferrer">Data types à la carte</a></li><li><a href="https://github.com/leanprover/lean4-samples/tree/main/ListComprehension" target="_blank" rel="noreferrer">Lean 4 list comprehension</a></li></ul></li><li>more about recursive schemes <ul><li><a href="https://maartenfokkinga.github.io/utwente/mmf91m.pdf" target="_blank" rel="noreferrer">Functional Programming with Bananas, Lenses, Envelopes and Barbed Wire</a></li></ul></li><li>lenses and other optics <ul><li><a href="https://www.fpcomplete.com/haskell/tutorial/lens/" target="_blank" rel="noreferrer">Lenses tutorial</a></li><li><a href="https://hackage.haskell.org/package/optics/docs/Optics.html" target="_blank" rel="noreferrer">Optics</a></li></ul></li></ul>`,41),c=[i];function r(A,d,C,g,u,h){return a(),n("div",null,c)}const f=s(o,[["render",r]]);export{m as __pageData,f as default};
