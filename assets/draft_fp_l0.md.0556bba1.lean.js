import{_ as s,v as a,b as n,R as l}from"./chunks/framework.3ac7bdc3.js";const e="/assets/rs.17f17407.png",p="/assets/parsec.88c31b1e.png",t="/assets/free.e658b495.png",m=JSON.parse('{"title":"Lean 函数式程序设计","description":"","frontmatter":{},"headers":[],"relativePath":"draft/fp/l0.md","filePath":"draft/fp/l0.md"}'),o={name:"draft/fp/l0.md"},i=l(`<h1 id="lean-函数式程序设计" tabindex="-1">Lean 函数式程序设计 <a class="header-anchor" href="#lean-函数式程序设计" aria-label="Permalink to &quot;Lean 函数式程序设计&quot;">​</a></h1><h2 id="动机" tabindex="-1">动机 <a class="header-anchor" href="#动机" aria-label="Permalink to &quot;动机&quot;">​</a></h2><ul><li>许多策略会被翻译成函数式程序设计的常见组分，学习函数式程序设计对读懂这些策略具体如何工作有帮助</li></ul><div class="language-Lean4"><button title="Copy Code" class="copy"></button><span class="lang">Lean4</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">def id {A : Type _} (x : A) : A := x</span></span>
